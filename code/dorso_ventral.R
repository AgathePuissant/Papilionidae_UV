...
meanphen_D_grayscale = match.phylo.data(subtree_analysis_1,meanphen_D_grayscale)$data
meanphen_V_grayscale = match.phylo.data(subtree_analysis_1,meanphen_V_grayscale)$data
...
subtree_analysis_2 = match.phylo.data(subtree,meanphen_D_grayscale)$phy
meanphen_D_vis = match.phylo.data(subtree_analysis_2,meanphen_D_vis)$data
meanphen_V_vis = match.phylo.data(subtree_analysis_2,meanphen_V_vis)$data
#Rate ratio visible
